  ...
  return (
    <section className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden bg-white dark:bg-black">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] bg-blue-400/10 dark:bg-blue-600/10 blur-[100px] rounded-full" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[40vw] h-[40vw] bg-emerald-400/10 dark:bg-cyan-600/10 blur-[100px] rounded-full" />
        {/* Subtle grid */}
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center max-w-7xl mx-auto px-4">
        ...
        >
          {/* The Glass Panel */}
          <div className="relative group overflow-hidden rounded-full p-[1px] transition-all duration-300 hover:scale-105 shadow-md">
            {/* Animated border gradient toned down */}
            <span className="absolute inset-0 bg-gradient-to-r from-blue-500/50 via-cyan-300/50 to-emerald-400/50 opacity-50 group-hover:opacity-100 transition-opacity" style={{ borderRadius: 'inherit' }} />
            
            <div className="relative flex items-center gap-4 px-6 py-3 rounded-full bg-white/70 dark:bg-black/70 backdrop-blur-md border border-slate-200 dark:border-white/10">
